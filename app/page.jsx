...
const Home = () => {
  ...
  return (
    <main className="relative bg-[#3B2273] px-[180px] py-[156px] flex items-center gap-[35px]">

      <section className="relative flex flex-col items-start gap-[31px]">
        <h1 className="h2 text-white w-[549px]">Your Ultimate Guide to Tennis</h1>
          <div className="flex flex-col gap-[17px] items-start">
            <Image src={headerLineIcon} alt="headerLine" className="w-[119px] h-[20px]"/>
            <p className="f16 fw400 lh24 text-white w-[500px]">Another important feature could be profiles of famous tennis players from around the world. This could include information on their playing style, career highlights, and current ranking.A section dedicated to coaching and training can also be included, which offers tips on improving tennis skills, such as serving, volleying, and footwork.</p>
          </div>
          <div className="flex items-center gap-[22px] w-full justify-start">
            <JoinPlayerBTN type="button" onClick={() => router.push('/register')}>Join As A Player</JoinPlayerBTN>
            <JoinClubBTN type="button" onClick={() => router.push('/club')}>Join As A Club</JoinClubBTN>
          </div>
      ...
      <section className="z-20 w-[751px] h-[501px]">
        <Image src={playerImage} alt="Player Image On Home page" className="rounded-xl z-20 w-full h-full object-cover"/>
      </section>
