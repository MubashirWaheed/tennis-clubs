    ...
    <div>
      <Modal heading="Reguest for account deletion">
        <p className="text-[#828282] f16 fw400">
          ...
          settings, look for the Delete Account or Close Account option. This
          may be located under a sub-menu or in a separate section on the page.
          You may be asked to confirm your decision to delete your account by
          entering your password or by clicking a confirmation button. After
